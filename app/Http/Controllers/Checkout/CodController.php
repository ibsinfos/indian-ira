...
class CodController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($orders->isNotEmpty()) {
            return response(['status' => 'success', 'location' => route('orderPlacedCodSuccess')]);
        }
    }

    /**
     * Display the cod thank you page.
     *
     * @return  \Illuminate\View\View
     */
    public function show()
    {
        return view('orders.placed_cod_success', compact('bank'));
    }
}
